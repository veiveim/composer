...
def classify(input_data, n_classes, n_hidden, batch_size, learning_rate, training_iters):
...
if __name__ == '__main__':
	...
	for n_hidden in arr:
		...
		for batch_size in arr:
			with tf.variable_scope("hidden_%s_%s" % (n_hidden, batch_size)):
				result = classify(input_data, int(n_classes), int(n_hidden), batch_size, learning_rate, training_iters)
